/*
 * Copyright 漏 2014 Kosma Moczek <kosma@cloudyourcar.com>
...
typedef struct serial_Data
{
	...
	struct minmea_time time;
	struct minmea_date date;
	unsigned char setHeightStatus;
	unsigned char MoterControlStatus;	
	unsigned char AutoOrManStatus;
	int statStren[12];
	float direc;	
	ICEPGS_Data rev_data;
}GPS_DATA;
